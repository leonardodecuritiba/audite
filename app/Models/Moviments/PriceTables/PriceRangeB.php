...
class PriceRangeB extends Model
{
    use SoftDeletes;
    use DateTimeTrait;
    use StringTrait;
	...
	{
		return route('conveyors.price-range.destroy-city',[$this->getAttribute('id'), 'B']);
	}
    ...
    {
        $value = '(Até 30kg) ' . DataHelper::getFloat2Currency($this->getAttribute('value_d'));
    ...
    {
        $value = '(Até 30kg) ' . DataHelper::getFloat2Currency($this->getAttribute('value_c'));
