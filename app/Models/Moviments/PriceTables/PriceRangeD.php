...
class PriceRangeD extends Model
{
    use SoftDeletes;
    use DateTimeTrait;
    use StringTrait;
	...
	{
		return route('conveyors.price-range.destroy-city',[$this->getAttribute('id'), 'D']);
	}
    ...
    public function getShortDescriptionDeliveryAttribute()
    {
        ...
        $excess = '(+%Ct-e) ' . DataHelper::getFloat2Percent($this->getAttribute('excess_d'));
        return $value . '; ' .
            $excess;
    }
    ...
    public function getShortDescriptionCollectAttribute()
    {
        ...
        $excess = '(+%Ct-e) ' . DataHelper::getFloat2Percent($this->getAttribute('excess_c'));
        return $value . '; ' .
            $excess;
    }
