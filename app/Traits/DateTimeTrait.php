...
trait DateTimeTrait {
    ...
    {
        return DataHelper::getHumanDateTime( $this->attributes['created_at'] );
    }

    public function getDeletedAtTimeAttribute()
    {
        return strtotime( $this->attributes['deleted_at'] );
    }

    public function getDeletedAtFormattedAttribute()
    {
        return DataHelper::getPrettyDateTime( $this->attributes['deleted_at'] );
    }
