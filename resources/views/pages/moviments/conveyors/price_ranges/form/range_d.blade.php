{{Form::open(array(
        'route' => ['conveyors.price-range-d.add-cities', $Data->id],
        'method'=>'POST',
...
<div class="card-body">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            {!! Html::decode(Form::label('excess_c', 'Excedente %Ct-e *', array('class' => 'col-form-label'))) !!}
            {{Form::text('excess_c', '0,00', ['placeholder' => 'Excedente %Ct-e', 'class'=>'form-control show-percent', 'required'])}}
            <div class="invalid-feedback"></div>
        </div>
    </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            {!! Html::decode(Form::label('excess_d', 'Excedente %Ct-e *', array('class' => 'col-form-label'))) !!}
            {{Form::text('excess_d', '0,00', ['placeholder' => 'Excedente %Ct-e', 'class'=>'form-control show-percent', 'required'])}}
            <div class="invalid-feedback"></div>
        </div>
    </div>
